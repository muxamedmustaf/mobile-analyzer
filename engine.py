...
MAX_SHOULDER_DEPTH_DIFF = 0.30  # نسبة التفاوت المسموح بها لتقارب عمق الكتفين (30%)
...
class PatternValidatorPipeline:
    ...
    def indicator_confirmation_filter(self, p, data):
        ...
        if self.pattern_type == "Head and Shoulders":
            # اشتراط RSI في النطاق المحايد إلى التشبع البيعي الحذر
            if not (30 <= rsi_val <= 70):
                return False, None, None
            # التثبت من توافق EMA: عدم كون السعر أعلى من EMA50 و EMA200 بفارق كبير
...
def detect_all_head_shoulders(pivots, df):
    ...
    for i in range(len(pivots) - 5):
        ...
        # ==========================================================
        # 1. إضافة شرط تقارب عمق الكتفين (Shoulder Depth Symmetry)
        # ==========================================================
        left_depth = h1 - l1
        right_depth = h3 - l2
        ...
        # استبعاد النموذج إذا كان التفاوت في عمق الكتفين أكبر من 30%
...
def detect_all_inverse_head_shoulders(pivots, df):
    ...
    for i in range(len(pivots) - 5):
        ...
        # ==========================================================
        # 1. إضافة شرط تقارب عمق الكتفين للنموذج المعكوس
        # ==========================================================
        left_depth = h1 - l1
        right_depth = h2 - l3
